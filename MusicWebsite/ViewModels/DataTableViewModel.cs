...
namespace MusicWebsite.ViewModels
{
    ...
    {
        //This view model class has been copied from https://www.echosteg.com/jquery-datatables-asp.net-mvc5-server-side
        ...
        public class DataTablesParameters
        {
            ...
            public string SortOrder
            {
                get
                {
                    if (this.Columns != null && this.Order != null && this.Order.Length > 0)
                    {
                        if (this.Order[0].Dir == DataTablesOrderDir.DESC)
                            return this.Columns[this.Order[0].Column].Data + " DESC";
                        else
                            return this.Columns[this.Order[0].Column].Data;
                    }
                    else
                        return null;
                }
